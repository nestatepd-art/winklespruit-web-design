...
const WebDesignKZN = () => (
  <LocalLandingPage
    ...
    city="KZN"
    slug="web-design-kzn"
    title="Web Design KZN | Custom Websites from R4,500 — Native Digital"
    description="Award-winning web design in KZN. Mobile-first, SEO-ready websites built to convert. From R4,500 once-off. Free AI audit included."
    hero={{
    ...
    priceNote="Once-off · 5-page Starter site · Includes domain & hosting setup."
  />
);
