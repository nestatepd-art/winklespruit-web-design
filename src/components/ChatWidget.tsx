  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          {/* Header */}
          <div className="p-4 bg-gradient-to-br from-primary to-secondary text-secondary-foreground">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <Sparkles className="w-5 h-5" />
              </div>
              <div>
                <div className="font-heading font-semibold text-base">Nia · Native Digital</div>
                <div className="text-xs font-medium opacity-95">Replies in seconds</div>
              </div>
            </div>
          </div>
          ...
          {/* Messages */}
            ...
            {messages.map((m, i) => (
              ...
              >
                <div className={cn(
                   "prose prose-sm max-w-none antialiased [&_p]:my-1 [&_ul]:my-1 [&_ol]:my-1 [&_*]:!text-current [&_a]:font-semibold [&_a]:underline [&_strong]:!font-bold [&_strong]:!text-current",
                )}>
